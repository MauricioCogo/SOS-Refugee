...
function RulesView() {
    ...
    return (
        <div>
            <Text h={"h4"} label={"Regras!"} font={"Lobster"} al={'center'} />
            <Accordion title={<span>da Recepção, <br />Credenciamento e Alojamento</span>} items={reception} pad={'20px'} />
            <Accordion title="das Refeições" items={meal} pad={'20px'} />
            <Accordion title="da Disciplina" items={discipline} pad={'20px'} />
            <Accordion title="Provas Campeiras e Culturais" items={competitions} pad={'50px'} />
            <Text h={"h4"} label={"Provas!"} font={"Lobster"} al={'center'} />
            <Accordion title="Melhor Acampamento" items={bestCamp} pad={'20px'} />
            <Accordion title="Truco Gaudério" items={truco} pad={'20px'} />
            <Accordion title="Revezamento do Mate" items={mate} pad={'20px'} />
            <Accordion title="Triatlo Campeiro" items={Triathlon} pad={'20px'} />
            <Accordion title="Tiro de Laço Vaca Parada" items={shooting} pad={'20px'} />
            <Accordion title="Pescaria Gaúcha" items={fishing} pad={'20px'} />
            <Accordion title="Artilharia Gaúcha" items={artillery} pad={'20px'} />
            <Accordion title="Cabo de Guerra" items={tug} pad={'20px'} />
            <Accordion title="Dança Gaúcha de Salão" items={dance} pad={'20px'} />
            <Accordion title="Tetarfe" items={tetarfe} pad={'20px'} />
            <Accordion title="Bocha Campeira" items={bocce} pad={'20px'} />
            <Accordion title="Arroz Carreteiro" items={rice} pad={'20px'} />
            <Accordion title="Prova dos Coordenadores" items={coord} pad={'20px'} />
            <Accordion title="das Apresentações de Danças" items={presentations} pad={'50px'} />
            <Text h={"h4"} label={"FECULT!"} font={"Lobster"} al={'center'} />
            <Accordion title={<span>do Festival da Canção <br />Cultural Tradicionalista</span>} items={fecult} pad={'20px'} />
            <Accordion title={<span>Categorias Música <br />Inédita e Música Conhecida</span>} items={music} pad={'20px'} />
            <Accordion title="Categoria Declamação" items={declamation} pad={'50px'} />
            <Text h={"h4"} label={"Adicionais!"} font={"Lobster"} al={'center'} />
            <Accordion title="das Premiações" items={awards} pad={'20px'} />
            <Accordion title="das Penalidades" items={penalties} pad={'60px'} />
        </div>
    );
}
